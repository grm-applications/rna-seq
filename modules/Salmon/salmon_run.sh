...
if [ `uname` == "Darwin" ]; then
	...
	do
		echo "Processing sample ${dir}"
		cd ${dir}
			../../modules/Salmon/salmon_0.99.0_beta2_linux_x86_64/bin/salmon quant -i ../../Reference/${filename}/ -l A -1 ${dir}_1.fastq -2 ${dir}_2.fastq -p 8 --validateMappings -o ../../Salmon/${dir}
		cd ..
